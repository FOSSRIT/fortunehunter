...
class BattleEngine:
  ...
  def draw(self,player,screen):
    ...
    screen.blit(pygame.transform.scale(pygame.image.load(HUD_PATH+"heart.gif"), (75, 75)), (50, 5))
    screen.blit(font.render(str(player.battlePlayer.HP), True, (255, 255, 255)), (50, 5))
