...
class BattleEngine:
  ...
  def draw(self,player,screen):
    ...
    screen.blit(pygame.transform.scale(pygame.image.load(HUD_PATH+"heart.gif"), (90, 90)), (100, 5))
    screen.blit(font.render(str(player.battlePlayer.HP), True, (255, 255, 255)), (1450, 50))
